...
.shape-blob {
    ...
    &.three {
        ...
        left: 80%;
        top: 24vw;
        animation: transform 7s ease-in-out infinite both alternate, movementTwo 23s ease-in-out infinite both;
    }
    ...
    &.four {
        ...
        left: 18vw;
        top: 36vw;
        animation: transform 17s ease-in-out infinite both alternate, movementTwo 13s ease-in-out infinite both;
    }
    ...
    &.five {
        ...
        left: 10%;
        top: 52vw;
        animation: transform 12s ease-in-out infinite both alternate, movementTwo 18s ease-in-out infinite both;
    }
    ...
    &.six {
        ...
        left: -8vw;
        top: 62vw;
        animation: transform 5s ease-in-out infinite both alternate, movementTwo 5s ease-in-out infinite both;
    }
}
