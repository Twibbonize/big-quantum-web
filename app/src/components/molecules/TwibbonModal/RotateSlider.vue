...
<template>
    <div :class="['rotate-slider', !enabled && 'rotate-slider--disabled']">
        <QButton square size="sm" @click="emit('decrease')" :enabled="enabled">
            <svg
        ...
        <QButton square size="sm" @click="emit('increate')" :enabled="enabled">
            <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
