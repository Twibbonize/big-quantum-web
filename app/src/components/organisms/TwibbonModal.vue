...
const rotatePhoto = (degree) => {
    ...
    // const step = 45;
    photoRotation.value = (currentRotation + degree + 540) % 360 - 180;
...
<template>
    <div class="twibbon-modal h-full">
        ...
        <Teleport to=".dialog__header">
            <div class="container flex items-center justify-between px-4 pb-3 lg:pt-3">
                <QButton variant="subtle" square class="-ml-2">
                    <i class="ri-close-line ri-2x font-light"></i>
                </QButton>

                <h1 class="text-base md:text-lg font-semibold">Create Twibbon</h1>
        ...
        <div class="twibbon-modal__body space-y-5">
            ...
            <div class="twibbon-modal__tools">
                <div class="rotate-slider">
                    ...
                    <input v-model="photoRotation" type="range" name="rotate" id="rotate" min="-180" max="180"
