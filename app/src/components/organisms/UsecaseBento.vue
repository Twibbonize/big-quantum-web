    ...
    <div class="use-case-bento">
        <div class="bento-container">
            <div
                ...
                :key="`bento-${i}`"
                class="bento card"
                :style="`--bg-color: ${bento.color}; --bg-image: ${bento.bg};`"
                :class="bento.classes"
            >
                <div class="px-5">
                    <h6 class="text-white text-xs uppercase tracking-widest">{{ bento.theme }}</h6>
                    <h5
                        class="font-semibold text-white text-xl mt-2.5"
                        :class="bento.titleClasses ? bento.titleClasses : 'sm:text-2xl'"
                    >
                        {{ bento.title }}
                    </h5>
                    <QOpenLink
...
.use-case-bento {
    ...
    .bento {
        ...
        .bg-pattern {
            @apply absolute top-0 right-0 max-w-[250px] z-0;
        }
    }
}
</style>
