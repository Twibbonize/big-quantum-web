...
<template>
    <div :class="['editor', `editor--${mode}`]">
        ...
        <QButton v-show="mode === 'create'" variant="secondary" size="sm" class="editor__add-variable" @click="addVariable">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                <path
                    ...
                    stroke="#707070" stroke-width="1.5808" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
            <span class="ml-1 font-normal">Add Custom Field</span>
        </QButton>

        <button v-show="mode === 'support'" variant="secondary" size="sm" class="editor__copy" @click="copyOutput">
            <i class="ri-clipboard-line"></i>
            <span class="ml-2 font-normal">Copy</span>
        </button>
    </div>
</template>
...
.editor {
    ...
    .editor__copy {
        @apply text-sm rounded-lg p-2 mt-3;
