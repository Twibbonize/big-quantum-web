...
const collectionsCard = computed(() => {
  return [
    ...
    },
    {
      ...
      sum: 12,
      campaigns: ['campaign-wedding-celebration-1.jpg', 'campaign-wedding-celebration-2.jpg', 'campaign-wedding-celebration-3.jpg'],
      url: '/collections/wedding-celebration'
    },
    {
      title: '🎓 Graduation',
      sum: 10,
      campaigns: ['campaign-graduation-1.jpg', 'campaign-graduation-2.jpg', 'campaign-graduation-3.jpg'],
      url: '/collections/graduation'
    },
    {
      title: '👶 New Baby',
      sum: 12,
      campaigns: ['campaign-new-baby-1.jpg', 'campaign-new-baby-2.jpg', 'campaign-new-baby-3.jpg'],
  ...
  <div class="campaign-collections">
    ...
    <div class="container mx-auto md:w-full pt-10">
      <QSlider
          ...
          :grab-cursor="true"
      >
        <swiper-slide class="w-fit first:ml-5" v-for="mood,i in moods" :key="`mood-${i}`">
          <QPills
            class="p-4 w-fit"
