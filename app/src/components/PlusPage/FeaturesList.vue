...
<template>
  <div class="plus-feature">
    <div class="container px-5 py-14">
      ...
      <p class="description">Experience an enhanced Twibbonize experience with Premium Basic plan</p>
      <div class="flex flex-col sm:flex-row gap-x-8 gap-y-6 mt-10 sm:mt-14">
        <div class="card" v-for="card, i in cards" :key="`feature-${i}`">
          ...
          <img class="card-image" :src="`/assets/img/campaigns/${card.image}`" :alt="card.title">
  ...
  .plus-feature {
    ...
    .card {
      ...
      .card-gradient {
        ...
        bottom: 0;
        height: 150px;
        background: linear-gradient(331deg, #FFF 3.18%, rgba(255, 255, 255, 0.00) 56.81%);
        z-index: 10;
      }
