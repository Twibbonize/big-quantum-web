...
<template>
  <div class="hero-participant hero-plus position-relative">
    ...
    <div class="hero-plus__content d-flex flex-column items-center">
      ...
      <p>Take action and make the most out of your moments with the help of our personalized templates suitable for every occassions</p>
    </div>
  </div>
</template>
