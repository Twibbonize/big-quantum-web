...
<template>
    <div class="creator-stories">
        ...
        >
            <div class="bento-1 sm:col-span-2 card py-5 cursor-pointer" @click="$router.push('/use-cases/visual-marvel')">
                <div class="px-5">
            ...
            <div class="bento-2 sm:col-span-2 card py-5 cursor-pointer" @click="$router.push('/use-cases/visual-marvel')">
                <div class="px-5">
            ...
            <div class="bento-3 sm:col-span-2 card py-5 cursor-pointer" @click="$router.push('/use-cases/visual-marvel')">
                <div class="px-5">
