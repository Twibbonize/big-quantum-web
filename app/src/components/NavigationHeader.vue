            ...
            <div class="flex flex-row items-center justify-between gap-x-4">
                <router-link to="/" class="w-3/12">
                    <picture class="logo">
                        <source
                            v-if="color === 'gradient'"
                            srcset="/src/assets/img/logos/twibbonize-logo-black.svg"
                        />
                        <source
                            v-else-if="color === 'transparent'"
                            srcset="/src/assets/img/logos/twibbonize-logo-white.svg"
                        />
                        <img
                            class="logo"
                            src="/src/assets/img/logos/twibbonize-logo.svg"
                            alt="twibbonize"
                        />
                    </picture>
                </router-link>
