                                                    ...
                                                    <div class="flex items-center w-full space-x-3">
                                                        ...
                                                        <div class="space-x-1 text-base">
                                                            <span class="text-black font-bold"
                                                                >Google</span
                                                            >
                                                            <span class="text-content font-light"
                                                                >(Not connected)</span
                                                            >
                                                        </div>
                                                    </div>
                                ...
                                <div class="space-y-6">
                                    <div class="space-y-6">
                                        <div class="space-y-2">
                                            ...
                                            <p class="text-sm text-content">
                                                Pick the notifications you want to get via push or
                                                email. These preferences only apply to push and
                                                email.
                                            </p>
                                        </div>
                                        ...
                                        <div class="max-w-2xl w-full">
                                            <div class="grid grid-cols-12 w-full gap-6">
                                                ...
                                                <div class="col-span-8 space-y-1">
                                                    ...
                                                    <div class="text-xs md:text-sm text-content">
                                                        You'll be notified of every progress on the
                                                ...
                                                <div class="col-span-8 space-y-1">
                                                    ...
                                                    <div class="text-xs md:text-sm text-content">
                                                        Get notifications of supporter's comment on
                                                        a campaign page.
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-span-8 space-y-1">
                                                    ...
                                                    <div class="text-xs md:text-sm text-content">
                                                        Get notifications about trending campaigns
                                                        in your region.
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-span-8 space-y-1">
                                                    ...
                                                    <div class="text-xs md:text-sm text-content">
                                                        Get the latest update of our product on the
