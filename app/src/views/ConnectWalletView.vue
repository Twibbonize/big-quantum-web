<template>
  <div class="overflow-hidden">
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body space-y-20 p-40">
            ...
            <p class="text-center">
              You have sucessfully connected your wallet, now you can start bidding or upload your
              own art!
            </p>
            <div class="d-flex justify-content-center space-x-20">
              <a href="#" data-dismiss="modal" class="btn btn-dark"> Discover Assets</a>
    ...
    <div class="modal fade popup" id="popup_error" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
    ...
    <div class="effect">
      <div class="container">
        <a href="/" class="btn btn-white btn-sm mt-20"> Back to home</a>
        <div class="hero__wallets pt-100 pb-50">
          <div class="space-y-20 d-flex flex-column align-items-center">
            <div class="logo">
              <img src="/src/assets/img/icons/logo.svg" alt="" />
            </div>
            ...
            <div class="wallets">
              <div class="row mb-20_reset">
                ...
                <div class="col-lg-4">
                  <a
                    href="#"
                    class="box in__wallet space-y-10"
                    data-toggle="modal"
                    data-target="#popup_connected"
                  >
                    <div class="logo">
                      <img src="/src/assets/img/icons/coibase.svg" alt="logo_community" />
                    </div>
                    <h5 class="text-center">coibase</h5>
                    <p class="text-center">
                ...
                <div class="col-lg-4">
                  ...
                  >
                    <div class="logo">
                      <img src="/src/assets/img/icons/metamask.svg" alt="logo_community" />
                    </div>
                ...
                <div class="col-lg-4">
                  ...
                  >
                    <div class="logo">
                      <img src="/src/assets/img/icons/torus.svg" alt="logo_community" />
                    </div>
                ...
                <div class="col-lg-4">
                  ...
                  >
                    <div class="logo">
                      <img src="/src/assets/img/icons/fortmatic.svg" alt="logo_community" />
                    </div>
                    <h5 class="text-center">fortmatic</h5>
                    <p class="text-center">
                      wallet that allows you to sign up with your phone number on any device
                    </p>
                  </a>
                </div>
                <!-- ================= item -->
                <div class="col-lg-4">
                  ...
                  >
                    <div class="logo">
                      <img src="/src/assets/img/icons/bitski.svg" alt="logo_community" />
                    </div>
                    <h5 class="text-center">bitski</h5>
                    <p class="text-center">
                      wallet that allows you to sign in with an email and password
                    </p>
                  </a>
                </div>
                <!-- ================= item -->
                <div class="col-lg-4">
                  ...
                  >
                    <div class="logo">
                      <img src="/src/assets/img/icons/walletconnect.svg" alt="logo_community" />
                    </div>
