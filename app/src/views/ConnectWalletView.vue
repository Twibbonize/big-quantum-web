              ...
              <div class="row mb-20_reset">
                ...
                <div class="col-lg-4">
                  <a href="#" class="box in__wallet space-y-10"
                    ...
                    <div class="logo">
                      <img
                        src="src/assets/img/icons/coibase.svg"
                        alt="logo_community">
                    </div>
                    <h5 class="text-center">coibase</h5>
                    <p class="text-center">wallet that works on both mobile and through a browser extension</p>
                  </a>
                </div>
                <!-- ================= item -->
                <div class="col-lg-4">
                  <a href="#" class="box in__wallet space-y-10"
                    ...
                    <div class="logo">
                      <img
                        src="src/assets/img/icons/metamask.svg"
                        alt="logo_community">
                    </div>
                    <h5 class="text-center">metamask</h5>
                    <p class="text-center">A browser extension with great flexibility. The web&#x27;s popular wallet</p>
                  </a>
                </div>
                <!-- ================= item -->
                <div class="col-lg-4">
                  <a href="#" class="box in__wallet space-y-10"
                    ...
                    <div class="logo">
                      <img
                        src="src/assets/img/icons/torus.svg"
                        alt="logo_community">
                    </div>
                ...
                <div class="col-lg-4">
                  <a href="#" class="box in__wallet space-y-10"
                    ...
                    <div class="logo">
                      <img
                        src="src/assets/img/icons/fortmatic.svg"
                        alt="logo_community">
                    </div>
                ...
                <div class="col-lg-4">
                  <a href="#" class="box in__wallet space-y-10"
                    ...
                    <div class="logo">
                      <img
                        src="src/assets/img/icons/bitski.svg"
                        alt="logo_community">
                    </div>
                ...
                <div class="col-lg-4">
                  <a href="#" class="box in__wallet space-y-10"
                    ...
                    <div class="logo">
                      <img
                        src="src/assets/img/icons/walletconnect.svg"
                        alt="logo_community">
                    </div>
