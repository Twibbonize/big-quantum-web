                          ...
                          <div class="col-row col-12">
                            <div class="blog-img">
                              <div class="meta absolute">
                                <a href="#" class="comments meta-info mobile">
                                  <svg
                                ...
                                <span class="views-counter meta-info mobile comments">
                                  <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24
                                                                    24"
                              ...
                              <img src="/src/assets/img/posts/post_1.jpg" alt="" />
                            </div>
                          </div>
                          <div class="col-row col-12">
                            <div class="blog-wrap">
                              <h3 class="blog-title">
                                <a href="/article"> Design Trends From Top Designers </a>
                              </h3>
                              <p class="blog-excerpt">
                                creabik is a digital design platform that combines a powerful,
                                native Mac app with collaboration features in the cloud. The Mac app
                                gives all the tools you need to
                              </p>
                              <div
                                class="blog-author-detail d-flex justify-content-between align-items-center"
                              >
                                <div
                                  class="c-customer-review-meta d-flex justify-content-start align-items-center"
                                >
                                  <div class="user">
                                    <img
                                  ...
                                  <div class="meta pl-20">
                                    <p class="name">Joshua William</p>
                                    <p class="author-post">Verified writer</p>
                                  </div>
                                </div>
                                <span class="font-semibold text-gray">08 May</span>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row align-items-center">
                          <div class="col-row col-12">
                            <div class="blog-img">
                              ...
                              <img src="/src/assets/img/posts/post_2.jpg" alt="" />
                            </div>
                          </div>
                          <div class="col-row col-12">
                            <div class="blog-wrap">
                              <h3 class="blog-title">
                                <a href="/article"> Behind the Scenes of the creabik App </a>
                              </h3>
                              <p class="blog-excerpt">
                                There was this general idea that the existent tools were not
                                tailored for UI/UX design, pair it with a strong codebase that
                                creabik was,
                              </p>
                              <div
                                class="blog-author-detail d-flex justify-content-between align-items-center"
                        ...
                        <div class="row align-items-center">
                          <div class="col-row col-12">
                            <div class="blog-img">
                              ...
                              <img src="/src/assets/img/posts/post_3.jpg" alt="" />
                            </div>
                          </div>
                          <div class="col-row col-12">
                            <div class="blog-wrap">
                              <h3 class="blog-title">
                                <a href="/article"> the official repository for designs </a>
                              </h3>
                              <p class="blog-excerpt">
                                I think my role back then was doing everything! Haha, we were a
                                two-man team for quite a while. I focused a lot of my time in
                                design,
                              </p>
                              <div
                                class="blog-author-detail d-flex justify-content-between align-items-center"
                        ...
                        <div class="row align-items-center">
                          <div class="col-row col-12">
                            <div class="blog-img">
                              ...
                              <img src="/src/assets/img/posts/post_4.jpg" alt="" />
                            </div>
                          </div>
                          <div class="col-row col-12">
                            <div class="blog-wrap">
                              <h3 class="blog-title">
                                <a href="/article"> Meet fennouni, Product Designer at GitHub </a>
                              </h3>
                              <p class="blog-excerpt">
                                We felt frustrated that there was no product that focused
                                specifically on interface design and we wanted to change that.
                              </p>
                              <div
                                class="blog-author-detail d-flex justify-content-between align-items-center"
                              >
                        ...
                        <div class="row align-items-center">
                          <div class="col-row col-12">
                            <div class="blog-img">
                              ...
                              <img src="/src/assets/img/posts/post_5.jpg" alt="" />
                            </div>
                          </div>
                          <div class="col-row col-12">
                            <div class="blog-wrap">
                              <h3 class="blog-title">
                                <a href="/article"> Simple, beautiful interfaces are the future </a>
                              </h3>
                              <p class="blog-excerpt">
                                hosting events, creating content and promoting the tool — and the
                                creabik community started blowing up.
                              </p>
                              <div
                                class="blog-author-detail d-flex justify-content-between align-items-center"
                              >
                        ...
                        <div class="row align-items-center">
                          <div class="col-row col-12">
                            <div class="blog-img">
                              ...
                              <img src="/src/assets/img/posts/post_6.jpg" alt="" />
                            </div>
                          </div>
                          <div class="col-row col-12">
                            <div class="blog-wrap">
                              <h3 class="blog-title">
                                <a href="/article"> The Winner of the Vice Presidential Debate </a>
                              </h3>
                              <p class="blog-excerpt">
                                I don&#x27;t think there was any one tool that was the inspiration
                                for creabik. We knew what we wanted to build, and I wanted an app
                              </p>
                              <div
                                class="blog-author-detail d-flex justify-content-between align-items-center"
                              >
                    ...
                    <ul class="pagination">
                      ...
                      <li class="page-item">
                        <a class="page-link" href="#!">
                          <i
                            class="ri-arrow-right-s-line md hydrated"
                            role="img"
                        ...
                        <div class="swiper-wrapper">
                          ...
                          <div class="swiper-slide">
                            ...
                            <article class="item">
                              ...
                              <div class="info">
                                <h4 class="title">
                                  <a href=""> How To Start Running Like A Pro </a>
                                </h4>
                                <div class="time">may 25, 2021</div>
                              </div>
                            </article>
