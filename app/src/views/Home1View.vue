          ...
          <div class="col-lg-6">
            <div class="hero__left space-y-20">
              ...
              <div class="space-x-20 d-flex flex-column flex-md-row sm:space-y-20">
                <a class="btn btn-primary" href="/marketplace">View market</a>
                <a class="btn btn-white" href="/upload-type"> Upload your item</a>
              </div>
            </div>
          </div>
          <div class="col-lg-6">
              ...
              <div class="swiper-slide">
                <div class="creator_item creator_card rounded_border space-x-10">
                  <div class="avatars space-x-10">
                    ...
                    <div>
                      <a href="/profile"><p class="avatars_name color_black">@xander_hall...</p></a>
              ...
              <div class="swiper-slide">
                <div class="creator_item creator_card rounded_border space-x-10">
                  <div class="avatars space-x-10">
                    ...
                    <div>
                      <a href="/profile"><p class="avatars_name color_black">@hamza_pitts...</p></a>
              ...
              <div class="swiper-slide">
                <div class="creator_item creator_card rounded_border space-x-10">
                  <div class="avatars space-x-10">
                    ...
                    <div>
                      <a href="/profile"
                        ><p class="avatars_name color_black">@nathan_walls...</p></a
                      >
              ...
              <div class="swiper-slide">
                <div class="creator_item creator_card rounded_border space-x-10">
                  <div class="avatars space-x-10">
                    ...
                    <div>
                      <a href="/profile"
                        ><p class="avatars_name color_black">@kelton_collier...</p></a
                      >
              ...
              <div class="swiper-slide">
                <div class="creator_item creator_card rounded_border space-x-10">
                  <div class="avatars space-x-10">
                    ...
                    <div>
                      <a href="/profile"><p class="avatars_name color_black">@cade_glover...</p></a>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
            <div class="card__item four">
              <div class="card_body space-y-10">
                ...
                <h6 class="card_title">
                  <a class="color_black" href="/item-details"> Synthwave Painting </a>
                </h6>
                <div class="card_footer d-block space-y-10">
                  <div class="card_footer justify-content-between">
                    <div class="creators">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
            <div class="card__item four">
              <div class="card_body space-y-10">
                ...
                <h6 class="card_title">
                  <a class="color_black" href="/item-details"> Contemporary Abstract </a>
                </h6>
                <div class="card_footer d-block space-y-10">
                  <div class="card_footer justify-content-between">
                    <div class="creators">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
            <div class="card__item four">
              <div class="card_body space-y-10">
                ...
                <h6 class="card_title">
                  <a class="color_black" href="/item-details"> Valkyrie Abstract Art </a>
                </h6>
                <div class="card_footer d-block space-y-10">
                  <div class="card_footer justify-content-between">
                    <div class="creators">
              ...
              <a href="/collections">
                <div class="collections_item">
                  <div class="images-box space-y-10">
                    <div class="top_imgs">
                      <img src="/src/assets/img/items/item_9.png" alt="" />
                      <img src="/src/assets/img/items/item_10.png" alt="" />
                      <img src="/src/assets/img/items/item_11.png" alt="" />
                    </div>
                    <img src="/src/assets/img/items/item_12.png" alt="" />
                  </div>
                </div>
              </a>
              <div class="collections_footer justify-content-between">
                <h5 class="collection_title"><a href="/collections">Creative Art collection</a></h5>
                <a href="#" class="likes space-x-3">
                  <i class="ri-heart-3-fill"></i>
            ...
            <div class="collections space-y-10 mb-30">
              <a href="/collections">
                <div class="collections_item">
                  <div class="images-box space-y-10">
                    <div class="top_imgs">
                      <img src="/src/assets/img/items/item_13.png" alt="" />
                      <img src="/src/assets/img/items/item_14.png" alt="" />
                      <img src="/src/assets/img/items/item_15.png" alt="" />
                    </div>
                    <img src="/src/assets/img/items/item_16.png" alt="" />
                  </div>
                </div>
              </a>
              <div class="collections_footer justify-content-between">
                <h5 class="collection_title">
                  <a href="/collections">Colorful Abstract Painting</a>
                </h5>
                <a href="#" class="likes space-x-3">
                  <i class="ri-heart-3-fill"></i>
            ...
            <div class="collections space-y-10 mb-30">
              <a href="/collections">
                <div class="collections_item">
                  <div class="images-box space-y-10">
                    <div class="top_imgs">
                      <img src="/src/assets/img/items/item_17.png" alt="" />
                      <img src="/src/assets/img/items/item_18.png" alt="" />
                      <img src="/src/assets/img/items/item_19.png" alt="" />
                    </div>
                    <img src="/src/assets/img/items/item_20.png" alt="" />
                  </div>
                </div>
              </a>
              <div class="collections_footer justify-content-between">
                <h5 class="collection_title"><a href="/collections">Modern Art collection</a></h5>
                <a href="#" class="likes space-x-3">
                  <i class="ri-heart-3-fill"></i>
      ...
      <div class="logos__wrap">
        <div class="row align-items-center justify-content-between">
          <div class="col-lg-auto col-md-12">
            <h3 class="section__title md:mb-20 text-left d-flex justify-content-center">
              Loved by the community
            </h3>
          </div>
          <div class="col-lg-auto col-md-12">
            <div
              class="d-flex flex-column flex-md-row justify-content-center space-x-20 sm:space-x-0 sm:space-y-20 align-items-center"
            >
