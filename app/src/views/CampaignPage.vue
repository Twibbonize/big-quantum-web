      ...
      <div class="action">
        <div class="card campaign-detail">
          ...
          <p class="campaign-description mt-4" :class="{ 'line-clamp-2': !isReadMore }">
            Welcome to Hanoi Art Book Fair 2023. Our primary mission is to cultivate reading habits, increase art literacy worldwide and build a new generation of readers, by making books more affordable.</p>
          <p v-if="!isReadMore" @click="clickReadMore" class="read-more mt-2">Read More</p>
...
.campaign-page {
  background:
    linear-gradient(0deg, #DEE8E8 9.54%, rgba(222, 232, 232, 0.00) 100.73%, rgba(222, 232, 232, 0.00) 100.73%),
  ...
  .card {
    ...
    box-shadow: 0px 5.064px 25.321px 0px rgba(0, 0, 0, 0.10);
  }

  .card-line {
    @apply w-full;
    border-top: rgba(27, 27, 27, 0.10) 1px solid;
  }
