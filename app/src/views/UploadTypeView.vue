          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="box text-center">
                <img class="icon mb-20" src="/src/assets/img/icons/single.svg" alt="" />
                <div class="space-y-10">
                  <h5>Sell One Time</h5>
                  <p class="color_text">your collectible want to be one of a kind</p>
                  <div class="hr"></div>
                  <a class="btn btn-grad btn" href="/upload"> create single </a>
                </div>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="box text-center">
                <img class="icon mb-20" src="/src/assets/img/icons/multiple.svg" alt="" />
                <div class="space-y-10">
                  <h5>Sell Multiple Time</h5>
                  <p class="color_text">your collectible want to be one of a kind</p>
                  <div class="hr"></div>
                  <a class="btn btn-grad btn" href="/upload"> create multiple </a>
                </div>
              </div>
            </div>
          </div>
