                  ...
                  <div>
                    <div class="avatars space-x-3">
                      <div class="-space-x-20">
                        <a class="d-none d-sm-inline" href="/profile">
                          <img
                            src="/src/assets/img/avatars/avatar_1.png"
                            alt="Avatar"
              ...
              <div class="box answers__box is__big space-y-20">
                  ...
                  <div class="d-flex">
                    ...
                    <div class="space-y-20">
                      <p class="forum__desc">
                        ...
                        auctioned and sold, my invite code will be unlocked so I can send invite. I
                        have no interest in selling invites for money but I realized I need to make
                        one sell before I can be able to invite others
                      </p>
                      <div class="reaction space-x-15">
                        <span class="like space-x-5">
                          <a href="#" class="like__btn"><i class="ri-thumb-up-line"></i></a>
                          <span>27 Like</span>
                        </span>
                ...
                <div>
                  ...
                  <div class="d-flex">
                    ...
                    <div class="space-y-20">
                      <p class="forum__desc">
                        Check regularly the website, cause I’m in the same situation. They will add
                        more artists sooner or later, check also the discord channel they have. But
                        most important, be patient and keep sharing your work in other social media
                      </p>
                      <div class="reaction space-x-15">
                        <span class="like space-x-5">
                          <a href="#" class="like__btn"><i class="ri-thumb-up-line"></i></a>
                ...
                <div>
                  ...
                  <div class="d-flex">
                    <div class="v__line last"></div>
                    <div class="space-y-20">
                      <p class="forum__desc">
                        Hi! To my part I was bored losing my time during days sharing my art on the
                        discord chan… That’s why I decided to bought the invitation! I’m so happy
                        now
                      </p>
                      <div class="reaction space-x-15">
                        <span class="like space-x-5">
            ...
            <div class="sidebar space-y-30">
              ...
              <div class="space-y-10">
                <div class="d-flex space-x-10">
                  <img src="/src/assets/img/icons/live.svg" alt="" style="width: 13px" />
                  <h5>Live auctions</h5>
                </div>
