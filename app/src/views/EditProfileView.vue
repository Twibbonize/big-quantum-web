                ...
                <div class="modal-body space-y-20 p-40">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <a class="tiktok-btn btn btn-primary mt-20
                            btn-sm" href="#">
                            <img class="mr-half" src="src/assets/img/icons/tiktok.svg" alt="" style="height: 20px;">
                            Connect to TikTok
                        </a>
                    </div>
                    <div class="d-flex flex-column">
                ...
                <div class="row profile-img">
                    <div class="col-6 col-md-2">
                        <div class="box
                            ...
                            align-items-center">
                            <img class="icon"
                                src="src/assets/img/icons/upload-plus.svg"
                                alt="" />
            ...
            <div>
                <div class="avatars space-x-20 mb-30">
                    <div id="profile-container">
                        <img id="profileImage" src="src/assets/img/avatars/avatar_3.png"
                ...
                <div class="box edit_box col-lg-9 space-y-30">
                    <div class="row sm:space-y-20">
                        ...
                        <div class="col-lg-6 social-media">
                            ...
                            <div class="form-group space-y-10">
                                <div class="space-y-40">
                                    <div class="d-flex flex-column">
                                        ...
                                        <a class="facebook-btn btn btn-primary mt-20
                                            btn-sm" href="#">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <a class="twitter-btn btn btn-primary mt-20
                                            btn-sm" href="#">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <a class="discord-btn btn btn-primary mt-20
                                            btn-sm" href="#">
                            ...
                            <a class="btn btn-white mt-20
                                btn-sm" href="#" data-toggle="modal"
