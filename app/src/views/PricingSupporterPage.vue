    ...
    <LayoutMain>
        <div class="pricing-supporter-header">
            ...
            <div class="no-more-ads">
                ...
                <p class="description">
                    Enjoy uninterrupted experience with no ads on Twibbonize. Get ready to embrace a
                    cleaner, more user-friendly version of Twibbonize.
                </p>
                <div class="bento">
                    <video
