                ...
                <div class="col-lg-8">
                    <div class="forum__content">
                        <ul class="nav nav-tabs d-flex mb-30" role="tablist">
                            <li class="nav-item">
                                <a class="btn btn-white btn-sm active"
                                    data-toggle="tab" href="#tabs-1" role="tab">
                                    Recent Questions</a>
                            </li>
                            <li class="nav-item">
                                <a class="btn btn-white btn-sm" data-toggle="tab"
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active space-y-30" id="tabs-1"
                                role="tabpanel">
                                <div class="box is__big space-y-20">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="space-y-20">
                                            <a href="post_details.html">
                                                <h3 class="forum__title">Localbitcoins
                                                    Clone Script | Localbitcoins
                                                    Clone Software</h3>
                                            </a>
                                            <p class="forum__desc">Hey guys! New
                                                exploration about NFT Marketplace
                                                Web Design, this time I'm inspired
                                                by one of my favorite NFT website
                                                called Rarible (with crypto
                                                payment)! What do you</p>
                                            <div class="tags">
                                            ...
                                            <div class="d-flex
                                                ...
                                                <div class="reaction">
                                                    ...
                                                    <a
                                                        href="post_details.html"
                                                        class="comments space-x-3">
                                                        <i class="ri-chat-1-line"></i>
                                                        <span class="txt_sm">257
                                                            Comments</span>
                                                    </a>
                                ...
                                <div class="box is__big space-y-20">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="space-y-20">
                                            <a href="post_details.html">
                                                <h3 class="forum__title">Thank you
                                                    you all for making this
                                                    community a
                                                    nice place to learn about NFTシ</h3>
                                            </a>
                                            <p class="forum__desc">Hey guys! I want
                                                to start buying interest art
                                                from crypto artists so please feel
                                                free to share anything. I really
                                                love animated pieces and 3d stuff,
                                                but I’d give a try to anything
                                                different or new (for me) like AR
                                                nft ...</p>
                                            <img class="img-fluid"
                                                src="../assets/img/bg/forum-post.png"
                                                alt="">
                                            <div class="tags">
                                                <span>#crypto Artists</span>
                                                <span>#NFT Artists</span>
                                ...
                                <div class="box is__big space-y-20">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="space-y-20">
                                            <a href="post_details.html">
                                                <h3 class="forum__title">Why to
                                                    Create an NFT On the Cardano
                                                    Blockchain?
                                                </h3>
                                            </a>
                                            <p class="forum__desc">Hey guys! NFTs,
                                                and especially NFT markets, have
                                                democratized the whole collectible
                                                art ecosystem. As a result, the
                                                new blockchain should make it simple
                                                for anybody to build their own
                                                NFT and trade it without difficulty.
                                                The possession of a ...</p>
                                            <div class="tags">
