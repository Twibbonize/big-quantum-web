<template>
  <div class="overflow-hidden">
    ...
    </header> <div class="hero_no_results">
        <div class="container">
            <div class="space-y-20">
                <div class="box search__box">
                    <i class="ri-search-line"></i>
                </div>
                <h1 class="text-center hero__title">Sorry, we couldn’t find any results
                    for this search.</h1>
                ...
                <div class="box input__box d-flex align-items-center space-x-20">
                    ...
                    <div><a href="#" class="btn btn-grad"><i class="ri-search-line"></i>Search</a></div>
                </div>
            </div>
        </div>
    </div>
