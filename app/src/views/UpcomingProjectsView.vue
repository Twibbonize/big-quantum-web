<template>
  <div class="overflow-hidden">
    ...
    <div class="hero_upcoming-projects bg_white">
      <div class="container">
        <div class="space-y-20">
          <h1 class="text-center hero__title">Upcoming NFT Projects</h1>
          <p class="text-center hero__desc">
    ...
    <section class="section /upcoming-projects mt-100">
      <div class="container">
          ...
          <table class="table /upcoming-projects">
            <thead>
              <tr>
                ...
                <th class="space-x-5" scope="col">
                  <i class="ri-price-tag-3-line"></i><span>Count</span>
                </th>
                <th class="space-x-5" scope="col">
                  <i class="ri-money-dollar-circle-line"></i><span>Price</span>
                </th>
                <th class="space-x-5" scope="col">
                  <i class="ri-file-line"></i><span>Extras</span>
                </th>
              </tr>
            </thead>
            <tbody>
              <tr>
                ...
                <td><img class="imh-fluid" src="/src/assets/img/icons/browsers.png" alt="" /></td>
