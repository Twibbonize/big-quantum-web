<template>
  <div class="overflow-hidden">
    ...
    </div><div class="hero_Live_Auctions">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5 col-md-12 col-sm-12 space-y-10 left_content">
                    <img class="img-fluid"
                        src="src/assets/img/icons/bid-grad.png" alt="bid icon"
                ...
                <div class="col-lg-7 col-md-12 col-sm-12">
                    <div class="card__item one">
                        <div class="card_body space-y-10">
                            <div class="row align-items-center">
                                <div class="col-xl-7 col-md-7 col-sm-7 space-y-20
                                    card_left">
                                    <div class="space-y-20">
                                        <h4>Colorful Abstract
                                            Painting</h4>
                                        <div class="details d-flex
                                            justify-content-between">
                                            <div class="bid">
                                                <div>
                                                    <p class="color_text txt_xs">CURRENT
                                                        BID</p>
                                                    <span class="txt_sm">4.77 ETH</span>
                                                </div>
                                            </div>
                                            <div class="auction_end">
                                                <p class="color_text txt_xs">AUCTION
                                                    END</p>
                                                <span class="counter txt_sm">56 : 34
                                                    : 00</span>
                                            </div>
                                        </div>
                                    </div>
