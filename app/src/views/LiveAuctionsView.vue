      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-5 col-md-12 col-sm-12 space-y-10 left_content">
            <img
              class="img-fluid"
              src="/src/assets/img/icons/bid-grad.png"
              alt="bid icon"
              style="max-width: 70px"
            />
            <h1 class="text-left">Live Auctions</h1>
            <p>
              Sign up to receive our monthly newsletter, featuring updates from the team, new
              decentralized applications and NFT projects, and trends we’re seeing in the space.
            </p>
          </div>
                ...
                <div class="row align-items-center">
                  <div class="col-xl-7 col-md-7 col-sm-7 space-y-20 card_left">
                    ...
                    <div class="d-flex justify-content-center space-x-20">
                      <div><a href="//item-details" class="btn btn-white">View Artwork</a></div>
                      <div>
                        <a
                          href="#"
                          data-toggle="modal"
