                                    ...
                                    <TabPanels>
                                        ...
                                        <TabPanel>
                                            <div class="card-box">
                                                <TabGroup>
                                                    <TabList>
                                                        <div class="stats-tabs flex items-center">
                                                            <Tab class="stat" v-slot="{ selected }">
                                                                <div
                                                                    :class="[
                                                                        'stat__wrapper',
                                                                        selected &&
                                                                            'stat__wrapper--selected'
                                                                    ]"
                                                                >
                                                                    <div
                                                                        class="stat__icon w-8 h-8 rounded-full bg-white text-main flex items-center justify-center"
                                                                    >
                                                                        <svg
                                                                            xmlns="http://www.w3.org/2000/svg"
                                                                            width="24"
                                                                        ...
                                                                        >
                                                                            <path
                                                                                fill-rule="evenodd"
                                                                                clip-rule="evenodd"
                                                                                d="M22.5 12C22.5 17.799 17.799 22.5 12 22.5C6.20101 22.5 1.5 17.799 1.5 12C1.5 6.20101 6.20101 1.5 12 1.5C17.799 1.5 22.5 6.20101 22.5 12ZM10.6163 7.75195C9.9659 7.75195 9.43359 8.28421 9.43359 8.94706C9.43359 9.6099 9.9659 10.1422 10.6163 10.1422C11.2667 10.1422 11.799 9.6099 11.799 8.94706C11.799 8.28421 11.2667 7.75195 10.6163 7.75195ZM8.68359 8.94706C8.68359 7.87562 9.54609 7.00195 10.6163 7.00195C11.6865 7.00195 12.549 7.87562 12.549 8.94706C12.549 10.0185 11.6865 10.8922 10.6163 10.8922C9.54609 10.8922 8.68359 10.0185 8.68359 8.94706ZM8.67869 13.096C9.19285 12.5777 9.88955 12.2871 10.6154 12.2871C11.3412 12.2871 12.0379 12.5777 12.5521 13.096C13.0663 13.6143 13.3558 14.318 13.3558 15.0523V15.3751H7.875V15.0523C7.875 14.318 8.16444 13.6143 8.67869 13.096ZM10.6154 11.5371C9.68871 11.5371 8.8006 11.9082 8.14626 12.5677C7.49202 13.2272 7.125 14.121 7.125 15.0523V15.7501C7.125 15.9572 7.29289 16.1251 7.5 16.1251H13.7308C13.9379 16.1251 14.1058 15.9572 14.1058 15.7501V15.0523C14.1058 14.121 13.7388 13.2272 13.0845 12.5677C12.4302 11.9082 11.5421 11.5371 10.6154 11.5371ZM13.0078 7.37695C13.0078 7.16985 13.1757 7.00195 13.3828 7.00195C13.8964 7.00195 14.3883 7.20761 14.7505 7.57271C15.1126 7.93772 15.3155 8.43214 15.3155 8.94706C15.3155 9.46197 15.1126 9.9564 14.7505 10.3214C14.3883 10.6865 13.8964 10.8922 13.3828 10.8922C13.1757 10.8922 13.0078 10.7243 13.0078 10.5172C13.0078 10.3101 13.1757 10.1422 13.3828 10.1422C13.6955 10.1422 13.996 10.017 14.2181 9.79318C14.4402 9.56927 14.5655 9.26497 14.5655 8.94706C14.5655 8.62914 14.4402 8.32484 14.2181 8.10094C13.996 7.87714 13.6955 7.75195 13.3828 7.75195C13.1757 7.75195 13.0078 7.58406 13.0078 7.37695ZM14.6264 11.6938C14.4331 11.6197 14.2162 11.7163 14.142 11.9097C14.0679 12.1031 14.1645 12.3199 14.3579 12.3941C14.8763 12.5928 15.3231 12.9458 15.6388 13.4066C15.9545 13.8675 16.1241 14.4144 16.1249 14.975V15.3744H15.4614C15.2543 15.3744 15.0864 15.5423 15.0864 15.7494C15.0864 15.9565 15.2543 16.1244 15.4614 16.1244H16.4999C16.707 16.1244 16.8749 15.9565 16.8749 15.7494V14.9748V14.9743C16.8739 14.2631 16.6588 13.5686 16.2575 12.9828C15.8562 12.397 15.2876 11.9473 14.6264 11.6938Z"
                                                                                fill="#16DAC1"
                                                                            />
                                                                        </svg>
                                                                    </div>
                                                        ...
                                                        <TabPanel>
                                                            <TabGroup>
                                                                ...
                                                                <TabPanels>
                                                                    <TabPanel>
                                                                        <div
                                                                            class="flex flex-col py-14 px-4 md:px-5 items-center justify-center space-y-2"
                                                                        >
                                                                            <h3
                                                                            ...
                                                                            <p
                                                                                class="text-content text-center font-light"
                                                                            >
                                                                                Not enough data to
                                                                                display in <br />
                                                                                selected time range.
...
.tabs {
    ...
    .tabs__tab {
        @apply relative outline-none py-4 md:py-6 flex items-center justify-center h-full text-black/50 tracking-wide font-semibold cursor-pointer transition-colors duration-200 ease-out;
