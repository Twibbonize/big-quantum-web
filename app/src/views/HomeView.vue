<template>
  <div class="overflow-hidden">
            ...
            <div class="row align-items-center justify-content-center mb-70 mt-60">
                ...
                <div class="col-lg-6">
                    <div class="hero__left space-y-20">
                        ...
                        <p class="hero__text txt">Raroin is a NFT Marketplace
                            Platform template . It’s come with a creative design,
                            home page options, different explore and digital asset
                            pages and items.</p>
                        <div class="space-x-20 d-flex flex-column flex-md-row
                            sm:space-y-20">
                            <a class="btn btn-primary" href="#Demos">View
                                Demos</a>
                    ...
                    <div class="box is__big hero_icons">
                        <div class="row">
                            ...
                            <div class="col-lg-4 space-y-10 text-center">
                                ...
                                <p>Price:</p>
                                <p class="color_black">Starting at <strong> $21</strong>
                                </p>
                            </div>
                            <div class="col-lg-4 space-y-10 text-center">
                                <i class="ri-information-line icon is_3"></i>
                                <p>Latest Version:</p>
                                <p class="color_black"> <span> 2.0.0</span> , 12 oct
                                    2021</p>
                            </div>
                        </div>
    ...
    </div><div class="section mt-100 demos_wrap">
        <div class="container">
            ...
            <div class="demos mt-100" id="Demos">
                <div class="row">
                    <div class="col-xl-3 col-md-4 col-sm-6">
                        <a href="/home-1" target="_blank" class="demo_item
                            space-y-10">
                            <div class="img_wrap">
                    ...
                    <div class="col-xl-3 col-md-4 col-sm-6">
                        <a href="/home-2" target="_blank" class="demo_item
                            space-y-10">
                            <div class="img_wrap">
                    ...
                    <div class="col-xl-3 col-md-4 col-sm-6">
                        <a href="/home-3" target="_blank" class="demo_item
                            space-y-10">
                            <div class="img_wrap">
    ...
    </div><div class="section mb-100 mt-40 demos_wrap">
        <div class="container">
            <div class="section__head">
                <h2 class="text-center title_demos mb-20"> Everything you need in
                    one place</h2>
                <div class="styles_tab d-none space-x-20">
                    <div class="item is_active">
                        <i class="ri-checkbox-blank-circle-line"></i>
            ...
            <div class="demos mt-100">
                <div class="row">
                    <div class="col-lg-3">
                        <a href="/marketplace" target="_blank" class="demo_item
                            is_lg
                            space-y-10">
                            <div class="img_wrap">
                                <img
                    ...
                    <div class="col-lg-9">
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <a href="/edit-profile" target="_blank" class="demo_item
                                    is_sm
                                    space-y-10">
                                    <div class="img_wrap">
                                        <img
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <a href="/item-details" target="_blank" class="demo_item
                                    is_sm
                                    space-y-10">
                                    <div class="img_wrap">
                                        <img
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <a href="/ranking" target="_blank" class="demo_item
                                    is_sm
                                    space-y-10">
                                    <div class="img_wrap">
                                        <img
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <a href="/live-auctions" target="_blank" class="demo_item
                                    is_sm
                                    space-y-10">
                                    <div class="img_wrap">
                                        <img
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <a href="/activity" target="_blank" class="demo_item
                                    is_sm
                                    space-y-10">
                                    <div class="img_wrap">
                                        <img
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <a href="/profile" target="_blank" class="demo_item
                                    is_sm
                                    space-y-10">
                                    <div class="img_wrap">
                                        <img
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <a href="/connect-wallet" target="_blank" class="demo_item
                            is_sm
                            space-y-10">
                            <div class="img_wrap">
                                <img
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <a href="/collections" target="_blank" class="demo_item
                            is_sm
                            space-y-10">
                            <div class="img_wrap">
                                <img
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <a href="/creators" target="_blank" class="demo_item
                            is_sm
                            space-y-10">
                            <div class="img_wrap">
                                <img
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <a href="/upload-type" target="_blank" class="demo_item
                            is_sm
                            space-y-10">
                            <div class="img_wrap">
                                <img
              ...
              <div class="demos mt-100">
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <a href="/post-details" target="_blank" class="demo_item
                                    is_sm
                                    space-y-10">
                                    <div class="img_wrap">
                                        <img
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <a href="/newsletter" target="_blank" class="demo_item
                                    is_sm
                                    space-y-10">
                                    <div class="img_wrap">
                                        <img
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <a href="/contact" target="_blank" class="demo_item
                                    is_sm
                                    space-y-10">
                                    <div class="img_wrap">
                                        <img
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <a href="/questions" target="_blank" class="demo_item
                                    is_sm
                                    space-y-10">
                                    <div class="img_wrap">
                                        <img
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <a href="/submit-request" target="_blank" class="demo_item
                                    is_sm
                                    space-y-10">
                                    <div class="img_wrap">
                                        <img
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <a href="/request" target="_blank" class="demo_item
                                    is_sm
                                    space-y-10">
                                    <div class="img_wrap">
                                        <img
                    ...
                    <div class="col-lg-3">
                        <a href="/forum" target="_blank" class="demo_item
                            is_lg
                            space-y-10">
                            <div class="img_wrap">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <a href="/blog" target="_blank" class="demo_item
                            is_sm
                            space-y-10">
                            <div class="img_wrap">
                                <img
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <a href="/article" target="_blank" class="demo_item
                            is_sm
                            space-y-10">
                            <div class="img_wrap">
                                <img
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <a href="/privacy" target="_blank" class="demo_item
                            is_sm
                            space-y-10">
                            <div class="img_wrap">
                                <img
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <a href="/register" target="_blank" class="demo_item
                            is_sm
                            space-y-10">
                            <div class="img_wrap">
                                <img
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <a href="/login" target="_blank" class="demo_item
                            is_sm
                            space-y-10">
                            <div class="img_wrap">
                                <img
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <a href="404.html" target="_blank" class="demo_item
                            is_sm
                            space-y-10">
                            <div class="img_wrap">
                                <img
            ...
            <div class="row justify-content-center changelog">
                <div class="col-lg-7">
                    <div class="overflow_log">
                        <div class="more_log btn btn-white btn-sm"> <span
                                class="change_text"> <i class="ri-more-fill"></i>
                            </span> </div>
                        <div class="box is__big">
                            <h2 class="text-center mb-40">Raroin Changelog</h2>
    
                            <div class="space-y-20">
                                <p class="text-center mb-20 color_brand"> V2.0.0
                                    <span
                                        class="color_red">(BIG UPDATE) </span> </p>
                                <div class="box change_log">
                                    <h6> Raroin Welcome page is now available
                                    </h6>
                                    <span class="bage new">NEW</span>
                                </div>
                                <div class="box change_log">
                                    <h6> add new <span class="color_green">21 page</span>
                                    </h6>
                                    <span class="bage new">NEW</span>
                                </div>
    
                                <p class="text-center mb-20 color_brand"> V1.8.0
                                </p>
                                <div class="box change_log">
                                    <h6> add forum page
                                    </h6>
                                ...
                                <div class="box change_log">
                                    <h6> fix responsive in style 4 item
                                    </h6>
                                    <span class="bage fix">FIX</span>
                                </div>
                                <div class="box change_log">
                                    <h6> add ranking NFT table
                                    </h6>
                                    <span class="bage new">NEW</span>
                                </div>
                                ...
                                <p class="text-center mb-20 color_brand"> V1.5.0
                                </p>
                                <div class="box change_log">
                                    <h6> add NFT bid popup with report item and
                                        profile popup
                                    </h6>
                                    <span class="bage new">NEW</span>
                                </div>
                                ...
                                <div class="box change_log">
                                    <h6> Add metamask Wallet to the template
                                    </h6>
                                    <span class="bage new">NEW</span>
                                </div>
                                <div class="box change_log">
                                    <h6>fix some javascript issues
                                    </h6>
                                    <span class="bage fix">FIX</span>
                                </div>
                                <div class="box change_log">
                                    <h6> add more social media to edit profile page
                                    </h6>
                                    <span class="bage upd">UPD</span>
                                </div>
                                <p class="text-center mb-20 color_brand"> V1.1.2
                                </p>
                                <div class="box change_log">
                                    <h6>add edit profile page
                                    </h6>
                                    <span class="bage new">NEW</span>
                                </div>
                                <div class="box change_log">
                                    <h6>change dropdown menu
                                    </h6>
                                    <span class="bage upd">UPD</span>
                                </div>
                                <div class="box change_log">
                                    <h6> add new item style
                                    </h6>
                                    <span class="bage new">NEW</span>
                                </div>
                                <div class="box change_log">
                                ...
                                <div class="box change_log">
                                    <h6>Add Animation to popular creators in home 2
                                    </h6>
                                    <span class="bage new">NEW</span>
                                </div>
                                <p class="text-center mb-20 color_brand"> V1.0.0
                                </p>
                                <div class="box change_log">
    ...
    <div class="section my-100">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="box box_buy border-0 hire_box text-center
                        space-y-20">
                        <h3> Need to Customize theme?</h3>
                        <p>if you want someone to help you with your project</p>
                        <a href="mailto:creabik@gmail.com" class="btn btn-primary">
                            Hire US </a>
                    </div>
                </div>
            </div>
    ...
    <a
        href="https://themeforest.net/item/raroin-nft-marketplace/33730631"
        target="_blank" class="raroin_purchase">
        ...
        <div class="container px-xl-0">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-lg-auto semibold links bottom0menu">
                    ...
                    <a href="https://themeforest.net/user/creabik" class="link
                        color_text">Creabik Team</a>
                </div>
            </div>
        </div>
    </footer>
