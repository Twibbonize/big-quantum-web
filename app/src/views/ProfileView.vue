                    ...
                    <div class="row justify-content-center mb-30_reset">
                      <div class="col-lg-6 col-md-6 col-sm-8">
                        <div class="collections space-y-10 mb-30">
                          ...
                          <div class="collections_footer justify-content-between">
                            <h5 class="collection_title"><a href="/profile">Creative Art collection
                              </a></h5>
                        ...
                        <div class="collections space-y-10 mb-30">
                          <div class="collections_item">
                            <div class="images-box space-y-10">
                              ...
                              <div>
                                <img src="src/assets/img/items/item_8.png"
                                  alt="">
                              </div>
                            </div>
                          </div>
                          <div class="collections_footer justify-content-between">
                            <h5 class="collection_title"><a href="/profile">Colorful Abstract collection
                              </a></h5>
                            <a href="#" class="likes space-x-3">
                              <i class="ri-heart-3-fill"></i>
                        ...
                        <div class="collections space-y-10 mb-30">
                          <div class="collections_item">
                            <div class="images-box space-y-10">
                              ...
                              <div>
                                <img src="src/assets/img/items/item_7.png"
                                  alt="">
                              </div>
                            </div>
                          </div>
                          <div class="collections_footer justify-content-between">
                            <h5 class="collection_title"><a href="/profile">Photography Art collection
                              </a></h5>
                            <a href="#" class="likes space-x-3">
                              <i class="ri-heart-3-fill"></i>
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-8">
                        <div class="collections space-y-10 mb-30">
                          ...
                          <div class="collections_footer justify-content-between">
                            <h5 class="collection_title"><a href="/profile">Fantasy Art collection
                              </a></h5>
                            <a href="#" class="likes space-x-3">
                              <i class="ri-heart-3-fill"></i>
                              <span class="txt_md">2.1k</span>
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-8">
                        <div class="collections space-y-10 mb-30">
                          ...
                          <div class="collections_footer justify-content-between">
                            <h5 class="collection_title"><a href="/profile">Pop Art collection
                              </a></h5>
                            <a href="#" class="likes space-x-3">
                              <i class="ri-heart-3-fill"></i>
                              <span class="txt_md">3.5k</span>
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-8">
                        <div class="collections space-y-10 mb-30">
                          ...
                          <div class="collections_footer justify-content-between">
                            <h5 class="collection_title"><a href="/profile">Contemporary Art collection
                              </a></h5>
                            <a href="#" class="likes space-x-3">
                              <i class="ri-heart-3-fill"></i>
                              <span class="txt_md">7.2k</span>
