  ...
  <div class="overflow-hidden">
    ...
    <div class="mb-100">
      <div class="hero__profile">
        <div class="cover">
          <img src="/src/assets/img/bg/prrofile.png" alt="" />
        </div>
        <div class="infos">
          <div class="container">
            <div class="row flex-wrap align-items-center justify-content-between">
              ...
              <div class="col-md-auto">
                <div class="d-flex flex-wrap align-items-center space-x-20 mb-20_reset">
                  <div class="mb-20">
                    <div class="copy">
                      <span class="color_text"> 13b9ebda0178... </span>
                      <a href="#">
                  ...
                  <div class="d-flex flex-wrap align-items-center space-x-20">
                    <div class="mb-20">
                      <a href="btn" class="btn btn-dark btn-sm"> Follow </a>
                    </div>
                    <div class="mb-20">
                      <div class="share">
                        <div class="icon">
            ...
            <div class="space-y-40">
              <div class="space-y-10">
                ...
                <div class="box space-y-20">
                  <p>
                    I make art with the simple goal of giving you something pleasing to look at for
                    a few seconds.
                  </p>
                  <div class="row">
                    <div class="col-6">
                      ...
                      <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="card__item three">
                          <div class="card_body space-y-10">
                            ...
                            <!-- =============== -->
                            <h6 class="card_title">
                              <a class="color_black" href="/item-details"> pop art Painting </a>
                            </h6>
                            ...
                            <div class="card_footer d-block space-y-10">
                              ...
                              <div class="d-flex align-items-center space-x-10">
                                ...
                                <span class="color_black txt_sm">0.022 ETH</span>
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="card_body space-y-10">
                            ...
                            <div class="card_footer d-block space-y-10">
                              ...
                              <div class="d-flex align-items-center space-x-10">
                                <i class="ri-vip-crown-line"></i>
                                <p class="color_text txt_sm" style="width: auto">Highest bid</p>
                                <span class="color_black txt_sm">0.075 ETH</span>
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="card_body space-y-10">
                            ...
                            <div class="card_footer d-block space-y-10">
                              ...
                              <div class="d-flex align-items-center space-x-10">
                                <i class="ri-vip-crown-line"></i>
                                <p class="color_text txt_sm" style="width: auto">Highest bid</p>
                                <span class="color_black txt_sm">0.074 ETH</span>
                              </div>
                            </div>
                          </div>
                        </div>
                            ...
                            <div class="card_footer d-block space-y-10">
                              <div class="d-flex justify-content-between align-items-center">
                                <div class="creators space-x-10">
                                  ...
                                  <a href="/profile">
                                    <p class="avatars_name txt_sm">@nacer_dahr..</p>
                                  </a>
                                </div>
                                <a href="#" class="space-x-3">
                                  <p class="color_green txt_sm">0.002 ETH</p>
                                </a>
                              </div>
                              <div class="hr"></div>
                              <div class="d-flex align-items-center space-x-10">
                                <i class="ri-vip-crown-line"></i>
                                <p class="color_text txt_sm" style="width: auto">Highest bid</p>
                                <span class="color_black txt_sm">0.063 ETH</span>
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="card_body space-y-10">
                            ...
                            <div class="card_footer d-block space-y-10">
                              <div class="d-flex justify-content-between align-items-center">
                                ...
                                <a href="#" class="space-x-3">
                                  <p class="color_green txt_sm">0.063 ETH</p>
                                </a>
                              </div>
                              <div class="hr"></div>
                              <div class="d-flex align-items-center space-x-10">
                                <i class="ri-vip-crown-line"></i>
                                <p class="color_text txt_sm" style="width: auto">Highest bid</p>
                                <span class="color_black txt_sm">0.054 ETH</span>
                              </div>
                            </div>
                          </div>
                        </div>
                            ...
                            <div class="card_footer d-block space-y-10">
                              <div class="d-flex justify-content-between align-items-center">
                                <div class="creators space-x-10">
                                  ...
                                  <a href="/profile">
                                    <p class="avatars_name txt_sm">@zain_gal..</p>
                                  </a>
                                </div>
                                <a href="#" class="space-x-3">
                                  <p class="color_green txt_sm">0.034 ETH</p>
                                </a>
                              </div>
                              <div class="hr"></div>
                              <div class="d-flex align-items-center space-x-10">
                                <i class="ri-vip-crown-line"></i>
                                <p class="color_text txt_sm" style="width: auto">Highest bid</p>
                                <span class="color_black txt_sm">0.084 ETH</span>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="row justify-content-center mb-30_reset">
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-8">
                        <div class="collections space-y-10 mb-30">
                          ...
                          <div class="collections_footer justify-content-between">
                            <h5 class="collection_title">
                              <a href="/profile">Colorful Abstract collection </a>
                            </h5>
                            <a href="#" class="likes space-x-3">
                              <i class="ri-heart-3-fill"></i>
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-8">
                        <div class="collections space-y-10 mb-30">
                          ...
                          <div class="collections_footer justify-content-between">
                            <h5 class="collection_title">
                              <a href="/profile">Photography Art collection </a>
                            </h5>
                            <a href="#" class="likes space-x-3">
                              <i class="ri-heart-3-fill"></i>
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-8">
                        <div class="collections space-y-10 mb-30">
                          ...
                          <div class="collections_footer justify-content-between">
                            <h5 class="collection_title">
                              <a href="/profile">Contemporary Art collection </a>
                            </h5>
                            <a href="#" class="likes space-x-3">
                              <i class="ri-heart-3-fill"></i>
                              <span class="txt_md">7.2k</span>
