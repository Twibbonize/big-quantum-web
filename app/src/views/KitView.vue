      ...
      <div class="container">
        ...
        <div class="buttons dashed_box bg_white">
          <div class="row justify-content-center justify-content-md-around">
            <div class="col-lg-auto col-sm-6 d-flex flex-column align-items-center">
            ...
            <div class="col-lg-auto col-sm-6 d-flex flex-column align-items-center">
              <span class="txt_sm color_text text-center mb-20">small Has icon</span>
              <div class="mb-20">
                <a class="btn btn-primary btn-sm" href="#"
                  ><i class="ri-donut-chart-fill sm"></i> Button</a
                >
              </div>
              <div class="mb-20">
              ...
              <div class="mb-20">
                <a class="btn btn-orange btn-sm" href="#"
                  ><i class="ri-donut-chart-fill sm"></i> Button</a
                >
              </div>
              <div class="mb-20">
                <a class="btn btn-green btn-sm" href="#"
                  ><i class="ri-donut-chart-fill sm"></i> Button</a
                >
              </div>
            </div>
            ...
            <div class="col-lg-auto col-sm-6 d-flex flex-column align-items-center">
              <span class="txt_sm color_text text-center mb-20">Default Has icon</span>
              <div class="mb-20">
                <a class="btn btn-primary" href="#"
                  ><i class="ri-donut-chart-fill md"></i> Button</a
                >
              </div>
              <div class="mb-20">
                <a class="btn btn-dark" href="#"><i class="ri-donut-chart-fill md"></i> Button</a>
              </div>
              <div class="mb-20">
                <a class="btn btn-grad" href="#"><i class="ri-donut-chart-fill md"></i> Button</a>
              </div>
              <div class="mb-20">
                <a class="btn btn-white" href="#"><i class="ri-donut-chart-fill md"></i> Button</a>
              </div>
              <div class="mb-20">
                <a class="btn btn-orange" href="#"><i class="ri-donut-chart-fill md"></i> Button</a>
              </div>
              <div class="mb-20">
                <a class="btn btn-green" href="#"><i class="ri-donut-chart-fill md"></i> Button</a>
              </div>
            </div>
            <div class="col-lg-auto col-sm-6 d-flex flex-column align-items-center">
              <span class="txt_sm color_text text-center mb-20">Large Has icon</span>
              <div class="mb-20">
                <a class="btn btn-primary btn-lg" href="#"
                  ><i class="ri-donut-chart-fill lg"></i> Button</a
                >
              </div>
              <div class="mb-20">
              ...
              <div class="mb-20">
                <a class="btn btn-grad btn-lg" href="#"
                  ><i class="ri-donut-chart-fill lg"></i> Button</a
                >
              </div>
              <div class="mb-20">
              ...
              <div class="mb-20">
                <a class="btn btn-orange btn-lg" href="#"
                  ><i class="ri-donut-chart-fill lg"></i> Button</a
                >
              </div>
              <div class="mb-20">
                <a class="btn btn-green btn-lg" href="#"
                  ><i class="ri-donut-chart-fill lg"></i> Button</a
                >
              </div>
            </div>
              ...
              <form action="text" class="row justify-content-center">
                <div class="col-lg-6 col-md-6">
                  <div class="form-group space-y-10">
                    ...
                    <input type="text" class="form-control" placeholder="input hover text here" />
                  </div>
                  <div class="form-group space-y-10">
                    <span class="nameInput">Label name</span>
                    <input
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body space-y-20 p-40">
                ...
                <p class="text-center">
                  your bid <span class="color_text txt _bold">(16ETH) </span> has been listing to
                  our database
                </p>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
              <div class="card__item one">
                <div class="card_body space-y-10">
                  ...
                  <div class="card_head">
                    ...
                    <div class="details d-flex justify-content-between">
                      <div class="bid space-x-10">
                        <div class="icon">
                          <img src="/src/assets/img/icons/ETH.svg" alt="..." />
                        </div>
                        <div>
                  ...
                  <div class="hr"></div>
                  <div class="card_footer justify-content-between flex-column flex-md-row">
                ...
                <div class="card_body space-y-10">
                  ...
                  <div class="card_head">
                    ...
                    <div class="action">
                      <a
                        href="#"
                        class="btn btn-primary btn-sm btn_auction"
                        data-toggle="modal"
                ...
                <div class="card_body space-y-10">
                  ...
                  <div class="card_footer d-block space-y-10">
                    <div class="card_footer justify-content-between">
                      ...
                      <a href="#" class="">
                        <p class="txt_sm">Price: <span class="color_green txt_sm">345 ETH</span></p>
                      </a>
                    </div>
                    <div class="hr"></div>
                    ...
                    <div class="avatars space-x-3">
                      ...
                      <div>
                        <p class="avatars_desc color_black">
                          ...
                          accepted an offer for about <span class="color_brand">$4,906</span> on
                          Bound To Fall In Love from <span class="bayer">@colborn</span>
                        </p>
                    ...
                    <div class="card_footer d-block space-y-10">
                      ...
                      <div class="d-flex align-items-center justify-content-between space-x-3">
                        <a
                          ...
                          >Place Bid</a
                        >
                        <span class="color_green txt_sm text-right">0.01 ETH</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="creator_item creator_card space-y-10 is_big">
                <div class="avatars flex-column space-y-10">
                  <div class="media has_border">
                    ...
                    <div class="has_number top">1</div>
                  </div>
                ...
                <div class="space-x-20 d-flex align-items-center">
                  <div class="header__notifications">
                    ...
                    <div class="notifications_popup space-y-20">
                      ...
                      <div
                        class="item space-x-20 d-flex justify-content-between align-items-center"
                      >
                        <img class="thumb" src="/src/assets/img/notifications/1.png" alt="..." />
                        <div class="details">
                  ...
                  <div class="header__avatar">
                    ...
                    <div class="avatar_popup space-y-20">
                      ...
                      <div class="links space-y-10">
                        <a href="#"> <i class="ri-landscape-line"></i> <span> My items</span> </a>
                        <a href="#"> <i class="ri-pencil-line"></i> <span> Edit Profile</span> </a>
                        <a href="#"> <i class="ri-logout-circle-line"></i> <span> Logout</span> </a>
                      </div>
                    </div>
                  </div>
