      ...
      <div class="container">
        <div class="mt-100">
          <h3 class="mb-40">
            <svg width="39" height="44" viewBox="0 0 39 44" fill="none"
              ...
              <path d="M18.816 43.904L16.016 27.552L0.448 33.376L0
                ...
                27.552L19.712 43.904H18.816Z" fill="#183B56" />
              </svg>
              Colors
            </h3>
          </div>
          <div class="color dashed_box bg_white">
            <div class="row mb-20_reset">
              <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                <div class="color_box space-y-10">
                  <div class="color_palette Brand"></div>
                  <h6 class="color_black">Brand</h6>
                </div>
              </div>
              <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                <div class="color_box space-y-10">
                  <div class="color_palette Gradient"></div>
                  <h6 class="color_black">Gradient</h6>
                </div>
              </div>
              <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                <div class="color_box space-y-10">
                  <div class="color_palette Black"></div>
                  <h6 class="color_black">Black</h6>
                </div>
              </div>
              <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                <div class="color_box space-y-10">
                  <div class="color_palette White"></div>
                  <h6 class="color_black">White</h6>
                </div>
              </div>
              <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                <div class="color_box space-y-10">
                  <div class="color_palette Light"></div>
                  <h6 class="color_black">Light</h6>
                </div>
              </div>
              <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                <div class="color_box space-y-10">
                  <div class="color_palette Hard_light"></div>
                  <h6 class="color_black">Hard light</h6>
                </div>
              </div>
              <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                <div class="color_box space-y-10">
                  <div class="color_palette Brand_light"></div>
                  <h6 class="color_black">Brand light</h6>
                </div>
              </div>
              <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                <div class="color_box space-y-10">
                  <div class="color_palette Red"></div>
                  <h6 class="color_black">Red</h6>
                </div>
              </div>
              <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                <div class="color_box space-y-10">
                  <div class="color_palette Green"></div>
                  <h6 class="color_black">Green</h6>
                </div>
              </div>
              <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                <div class="color_box space-y-10">
                  <div class="color_palette Info"></div>
                  <h6 class="color_black">Info</h6>
                </div>
              </div>
              <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                <div class="color_box space-y-10">
                  <div class="color_palette Stroke"></div>
                  <h6 class="color_black">Stroke</h6>
                </div>
              </div>
              <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                <div class="color_box space-y-10">
                  <div class="color_palette Text"></div>
                  <h6 class="color_black">Text</h6>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="mt-100">
            ...
            <div class="buttons dashed_box bg_white">
              <div class="row justify-content-center justify-content-md-around">
                <div class="col-lg-auto col-sm-6 d-flex flex-column
                  align-items-center">
                  <span class="txt_sm color_text text-center mb-20">Small</span>
                  <div class="mb-20">
                    <a class="btn btn-primary btn-sm" href="#">Button</a>
                  </div>
                  <div class="mb-20">
                    <a class="btn btn-dark btn-sm" href="#">Button</a>
                  </div>
                  <div class="mb-20">
                    <a class="btn btn-grad btn-sm" href="#">Button</a>
                  </div>
                  <div class="mb-20">
                    <a class="btn btn-white btn-sm" href="#">Button</a>
                  </div>
                  <div class="mb-20">
                    <a class="btn btn-orange btn-sm" href="#">Button</a>
                  </div>
                  <div class="mb-20">
                    <a class="btn btn-green btn-sm" href="#">Button</a>
                  </div>
                </div>
                <div class="col-lg-auto col-sm-6 d-flex flex-column
                  align-items-center">
                  <span class="txt_sm text-center color_text mb-20">Default</span>
                  <div class="mb-20">
                  ...
                  <div class="mb-20">
                    <a class="btn btn-green" href="#">Button</a>
                  </div>
                </div>
                <div class="col-lg-auto col-sm-6 d-flex flex-column
                  align-items-center">
                  <span class="txt_sm color_text text-center mb-20">Large</span>
                  <div class="mb-20">
                    <a class="btn btn-primary btn-lg" href="#">Button</a>
                  </div>
                  <div class="mb-20">
                    <a class="btn btn-dark btn-lg" href="#">Button</a>
                  </div>
                  <div class="mb-20">
                    <a class="btn btn-grad btn-lg" href="#">Button</a>
                  </div>
                  <div class="mb-20">
                    <a class="btn btn-white btn-lg" href="#">Button</a>
                  </div>
                  <div class="mb-20">
                    <a class="btn btn-orange btn-lg" href="#">Button</a>
                  </div>
                  <div class="mb-20">
                    <a class="btn btn-green btn-lg" href="#">Button</a>
                  </div>
                </div>
            
                <div class="col-lg-auto col-sm-6 d-flex flex-column
                  align-items-center">
                  <span class="txt_sm color_text text-center mb-20">small
                    Has icon</span>
                  <div class="mb-20">
                  ...
                  <div class="mb-20">
                    <a class="btn btn-dark btn-sm" href="#"><i
                        class="ri-donut-chart-fill
                        sm"></i> Button</a>
                  </div>
                  <div class="mb-20">
                    <a class="btn btn-grad btn-sm" href="#"><i
                        class="ri-donut-chart-fill
                        sm"></i> Button</a>
                  </div>
                  <div class="mb-20">
                  ...
                  <div class="mb-20">
                    <a class="btn btn-orange btn-sm" href="#"><i
                        class="ri-donut-chart-fill
                        sm"></i> Button</a>
                  </div>
                  <div class="mb-20">
                    <a class="btn btn-green btn-sm" href="#"><i
                        class="ri-donut-chart-fill
                        sm"></i> Button</a>
                  </div>
                </div>
                ...
                <div class="col-lg-auto col-sm-6 d-flex flex-column
                  align-items-center">
                  <span class="txt_sm color_text text-center mb-20">Default
                    Has icon</span>
                  <div class="mb-20">
                  ...
                  <div class="mb-20">
                    <a class="btn btn-dark" href="#"><i
                        class="ri-donut-chart-fill
                        md"></i> Button</a>
                  </div>
                  <div class="mb-20">
                    <a class="btn btn-grad" href="#"><i
                        class="ri-donut-chart-fill
                        md"></i> Button</a>
                  </div>
                  <div class="mb-20">
                  ...
                  <div class="mb-20">
                    <a class="btn btn-orange" href="#"><i
                        class="ri-donut-chart-fill
                        md"></i> Button</a>
                  </div>
                  <div class="mb-20">
                    <a class="btn btn-green" href="#"><i
                        class="ri-donut-chart-fill
                        md"></i> Button</a>
                  </div>
                </div>
                <div class="col-lg-auto col-sm-6 d-flex flex-column
                  align-items-center">
                  <span class="txt_sm color_text text-center mb-20">Large
                    Has icon</span>
                  <div class="mb-20">
                  ...
                  <div class="mb-20">
                    <a class="btn btn-dark btn-lg" href="#"><i
                        class="ri-donut-chart-fill
                        lg"></i> Button</a>
                  </div>
                  <div class="mb-20">
                    <a class="btn btn-grad btn-lg" href="#"><i
                        class="ri-donut-chart-fill
                        lg"></i> Button</a>
                  </div>
                  <div class="mb-20">
                    <a class="btn btn-white btn-lg" href="#"><i
                        class="ri-donut-chart-fill
                        lg"></i> Button</a>
                  </div>
                  <div class="mb-20">
                    <a class="btn btn-orange btn-lg" href="#"><i
                        class="ri-donut-chart-fill
                        lg"></i> Button</a>
                  </div>
                  <div class="mb-20">
                    <a class="btn btn-green btn-lg" href="#"><i
                        class="ri-donut-chart-fill
                        lg"></i> Button</a>
                  </div>
                </div>
          ...
          <div class="container">
            <div class="mt-100">
              ...
              <div class="row">
                  <div class="col-lg-9">
                      <div class="form_cc_four mb-20">
                          <form action="text" class="row justify-content-center">
                              <div class="col-lg-6 col-md-6">
                                  <div class="form-group space-y-10">
                                      <span class="nameInput">Label name</span>
                                      <input
                                          type="text"
                                          class="form-control"
                              ...
                              <div class="col-lg-6 col-md-6">
                                  <div class="form-group space-y-10">
                                      <span class="variationInput">has variation</span>
                                      <select
                                  ...
                                  <div class="form-group space-y-10">
                                      <span class="variationInput">has variation</span>
                                      <select
                                          class="form-select custom-select input_white"
                                          aria-label="Default select example">
                                          <option>Please Select</option>
                                          <option>Purchase</option>
                                          <option>Support</option>
                              ...
                              <div class="dashed_border_h mt-20 mb-40"></div>
                              <div class="col-lg-6 col-md-6">
                  ...
                  <div class="col-lg-3">
                      <div class="row space-y-20">
                          <div class="col">
                              <div class="form_cc_four">
                                  <ul class="space-y-10 mn_with">
                          ...
                          <div class="col">
                              <div class="d-flex space-x-10">
                                  <div class="share">
                                      <div class="share_box visible position-relative">
                                          <ul class="space-y-10">
                                              <li>
                                              ...
                                              <li>
                                                  <a href=""> <i class="ri-messenger-line"></i>
                                                  </a>
                                              </li>
                                              <li>
                                                  <a href=""> <i class="ri-whatsapp-line"></i>
                                                  </a>
                                              </li>
                                              <li>
                                  ...
                                  <div class="more">
                                      <div class="more_box visible position-relative">
                                          <ul class="space-y-10">
                                              <li>
            ...
            <div class="container">
              <div class="mt-100">
                <h3 class="mb-40">
                  <svg width="39" height="44" viewBox="0 0 39 44"
                    ...
                    <path d="M18.816 43.904L16.016 27.552L0.448
                      33.376L0
                ...
                <div class="typoghraphy dashed_box bg_white">
                  <div class="row">
                
                    <div class="col-lg-4">
                      <div class="space-y-20">
                        <p class="txt_sm color_black">
                          Body text small for small <br />
                          paragraphs.
                        </p>
                        <p class="txt_sm _bold color_black">
                          Body text small & bold for small <br />
                          paragraphs.
                        </p>
                        <p class="txt_xs color_black">
                          Body text xsmall for xsmall <br />
                          paragraphs.
                        </p>
                        <p class="txt_xs _bold color_black">
                    ...
                    <div class="col-lg-4">
                      <div class="space-y-20">
                        <p class="txt color_black">
                          Body text normal for normal <br />
                          paragraphs.
                        </p>
                        <p class="txt _bold color_black">
                          Body text normal & bold for normal <br />
                          paragraphs.
                        </p>
                        <p class="txt_lg color_black">
                          Body text large for big <br />
                          paragraphs.
                        </p>
                        <p class="txt_lg _bold color_black">
              ...
              <div class="container">
                <div class="mt-100">
                  ...
                  </div><div class="dashed_box">
                    <div class="row mb-100 mb-30_reset">
                      <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="card__item one">
                          <div class="card_body space-y-10">
                            ...
                            <div class="card_head">
                              ...
                              <div class="details d-flex justify-content-between">
                                <div class="bid space-x-10">
                                  <div class="icon">
                                    <img src="src/assets/img/icons/ETH.svg"
                                      alt="..." />
                                  </div>
                                  <div>
                            ...
                            <div class="hr"></div>
                            <div class="card_footer justify-content-between flex-column
                              flex-md-row">
                          ...
                          <div class="card_body space-y-10">
                            ...
                            <div class="card_footer d-block space-y-10">
                              ...
                              <a href="#" class="d-flex align-items-center
                                ...
                                <p class="color_text txt_sm" style="width: auto">Highest
                                  bid</p>
                            ...
                            <div class="card_head">
                              ...
                              <div class="block_timer">
                                <div class="d-flex justify-content-center
                                  align-items-center">
                                  <div class="item">
                                    <div class="number txt hours">09<span></span></div>
                                  </div>
                                  <div class="dots">:</div>
                                  <div class="item">
                                  ...
                                  <div class="dots">:</div>
                                  <div class="item">
                                    <div class="number txt seconds">17<span></span></div>
                                  </div>
                                </div>
                              </div>
                              <div class="details d-flex justify-content-between">
                        ...
                        <div class="card__item four">
                          <div class="card_body space-y-10">
                            ...
                            <div class="creators space-x-10">
                              <div class="avatars space-x-3">
                                <a href="/profile">
                                  <img src="src/assets/img/avatars/avatar_3.png"
                                    alt="Avatar"
                                    class="avatar avatar-sm" />
                                </a>
                                <a href="/profile">
                                  <p class="avatars_name txt_sm">@mickel_fenn</p>
                                </a>
                              </div>
                              <div class="avatars space-x-3">
                                <a href="/profile">
                                  <img src="src/assets/img/avatars/avatar_4.png"
                                    alt="Avatar"
                                    class="avatar avatar-sm" />
                                </a>
                                <a href="/profile">
                            ...
                            <div class="card_footer d-block space-y-10">
                              <div class="card_footer justify-content-between">
                                <div class="creators">
                                  <p class="txt_sm">3 in stock</p>
                                </div>
                                <a href="#" class="">
                                  <p class="txt_sm">
                                    Price: <span class="color_green txt_sm">345
                                      ETH</span>
                                  </p>
                                </a>
                              </div>
                          ...
                          <div class="card_body space-y-10">
                            ...
                            <div class="creators space-x-10">
                              <div class="avatars space-x-3">
                                ...
                                <div>
                                  <p class="avatars_desc color_black">
                                    <span class="txt _bold">@samj</span>
                                    accepted an offer for
                                    about <span class="color_brand">$4,906</span>
                                    on Bound To Fall
                                    In Love from <span class="bayer">@colborn</span>
                                  </p>
                                  <span class="time color_text">23 min ago</span>
                                </div>
                              </div>
                            </div>
                            <div class="card_head">
                              ...
                              <div class="card_footer d-block space-y-10">
                                ...
                                <div class="d-flex
                                  ...
                                  <a class="btn btn-sm btn-primary" href="#"
                                    data-toggle="modal"
                                    data-target="#popup_bid">Place Bid</a>
                                  <span class="color_green txt_sm text-right">0.01
                                    ETH</span>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="card_body">
                            ...
                            <div class="card_footer"> 
                              <div class="details space-y-10">
                                <h4 class="card_title">Colorful Pockemon Red Dragon</h4>
                                <div class="card_wrap space-x-20">
                                  <div class="bid">
                                    <p class="color_text txt_xs">MINIMUM BID</p>
                                    <span class="txt_sm _bold">4.77 ETH</span>
                                  </div>
                                  <div class="auction_end">
                                    <p class="color_text txt_xs">COUNTDOWN</p>
                                    <span class="counter txt_sm _bold">56 : 34 : 00</span>
                                  </div>
                                  <div class="bid_btn">
                                    <a href="#" class="btn btn-grad btn-sm" data-toggle="modal" data-target="#popup_bid">Place Bid</a>
                                  </div>
                                </div>
                              </div>
                            </div>
                ...
                <div class="container">
                  <div class="mt-100">
                    <h3 class="mb-40">
                      <svg width="39" height="44" viewBox="0 0 39
                        44"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path d="M18.816 43.904L16.016
                          27.552L0.448
                          33.376L0
                          32.592L12.768 21.952L0 11.424L0.448
                          10.64L16.016
                    ...
                    <div class="dashed_box">
                      <div class="row">
                          ...
                          <div class="creator_item creator_card rounded_border space-x-10">
                            <div class="avatars space-x-10">
                              ...
                              <div>
                                ...
                                <span class="price color_text">16.58 ETH</span>
                              </div>
                            </div>
                          </div>
                          <!-- creator_item -->
                          ...
                          <div class="creator_item creator_card space-y-10 is_big">
                            <div class="avatars flex-column space-y-10">
                              <div class="media has_border">
                                ...
                                <div class="has_number top">
                                  1
                                </div>
                              </div>
                              <div class="text-center">
                                <a href="/profile">
                                  <p class="avatars_name large color_black">@ayoub_fennouni</p>
                                </a>
                                <span class="sales color_text">27 sales on 12 ETH</span>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                          <!-- creator_item -->
                          <div class="creator_item creator_card space-y-10">
                            <div class="avatars flex-column space-y-10">
                              <div class="cover"></div>
                              <div class="media">
                                <a href="/profile">
                              ...
                              <div class="details text-center">
                                <div>
                                  <p class="color_black txt_lg">
                                    191 <span class="color_text txt_sm">ETH</span>
                                  </p>
                  ...
                  <div class="container">
                    <div class="mt-100">
                      <h3 class="mb-40">
                        <svg width="39" height="44" viewBox="0 0
                          39
                          44" fill="none"
                          xmlns="http://www.w3.org/2000/svg">
                          <path d="M18.816 43.904L16.016
                      ...
                      <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-10">
                          <div class="collections space-y-10 dashed_box">
                            ...
                            <div class="creators space-x-10">
                              <span class="color_text txt_md"> 31 items · Created by</span>
                              <div class="avatars">
                                <a href="/profile">
                                  <img
                                    src="src/assets/img/avatars/avatar_2.png"
                              ...
                              <a href="/profile">
                                <span class="avatars_name txt_sm"> @makinzi_jamy... </span>
                              </a>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="container">
                      <div class="mt-100">
                        ...
                        <div class="headers space-y-20 dashed_box">
                            ...
                            <div class="container">
                              <div class="wrapper js-header-wrapper">
                                ...
                                <div class="header__menu">
                                  <ul class="d-flex space-x-20">
                                    <li class="has_popup">
                                      <a class="color_brand" href="#">Explore</a>
                                    </li>
                                    <li><a class="color_black" href="#"> How it works</a></li>
                                    <li><a class="color_black" href="#"> Company</a></li>
                                    <li><a class="color_black" href="#"> Pages</a></li>
                                  </ul>
                                </div>
                                <div class="header__search">
                                  <input type="text" placeholder="Search" />
                                ...
                                <div class="header__btns">
                                  <a class="btn btn-grad btn-sm" href="#">Connect wallet</a>
                                </div>
                                <div class="header__burger js-header-burger"></div>
                          ...
                          <header class="header__1 js-header">
                            <div class="container">
                              <div class="wrapper js-header-wrapper space-x-20">
                                ...
                                <div class="space-x-20 d-flex align-items-center">
                                  <div class="header__notifications">
                                    <div class="js-notifications-icon">
                                      <i class="ri-notification-3-line"></i>
                                    </div>
                                    <div class="notifications_popup space-y-20">
                                      <div class="d-flex justify-content-between">
                                        <h5>Notifications</h5>
                                        <a href="#" class="badge color_white">View all</a>
                                      </div>
                                      <div
                                        class="item
                                        space-x-20
                                  ...
                                  <div class="header__avatar">
                                    ...
                                    <div class="avatar_popup space-y-20">
                                      ...
                                      <div class="links space-y-10">
                                        <a href="#">
                                          <i class="ri-landscape-line"></i> <span> My
                                            items</span>
                                        </a>
                                        <a href="#">
                                          <i class="ri-pencil-line"></i> <span> Edit
                                            Profile</span>
                                        </a>
                                        <a href="#">
                                          <i class="ri-logout-circle-line"></i> <span>
                                            Logout</span>
                                        </a>
                                      </div>
                                    </div>
                      ...
                      <div class="container">
                        <div class="mt-100">
                          <h3 class="mb-40">
                            ...
                            <div class="footers dashed_box">
                              <footer class="footer__1 m-0">
                                <div class="container">
                                  <div class="row">
                                    <div class="col-lg-6 space-y-20">
                                      <div class="footer__logo">
                                        <a href="#">
                                          <img src="src/assets/img/logos/Logo.svg"
                                            alt="logo" />
                                        </a>
                                      </div>
                                  ...
                                  <p class="copyright text-center">
                                    Copyright © 2021. Crafted with love by creabik.
                                  </p>
                                </div>
                              </footer>
                            </div>
