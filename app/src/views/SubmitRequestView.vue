    ...
    <div class="requests">
      <div class="container">
        <div class="row gx-5 justify-content-center">
          <div class="col-lg-8 col-md-10 requests__content">
            <div class="requests__wrap space-y-20">
              <div>
                <h1 class="text-left">Submit a request</h1>
              </div>
              <div class="box is__big">
                <div class="space-y-20 mb-0">
                  <div class="space-y-10">
                    <span class="nameInput">Your email address</span>
                    <input type="email" class="form-control" placeholder="contact@Creabik.com" />
                  </div>
                  <div class="space-y-10">
                    <span class="nameInput">Subject</span>
                    <input type="text" class="form-control" />
                  </div>
                  <div class="space-y-10">
                    <span class="nameInput">Description</span>
                    <textarea style="min-height: 110px" class="mb-0"> </textarea>
                    <p>
                  ...
                  <div class="requests_footer">
                    <div class="Attach_desc space-x-20">
                      <div class="Attach_file">
                        <a href="#" class="btn btn-white" style="min-width: max-content">
                          Attach file
                        </a>
                        <input type="file" />
                      </div>
                      <p class="txt_sm">
                        Maximum file size: <span class="color_black">800 MB</span>
                      </p>
                    </div>
                    <div>
                      <a href="/request" class="btn btn-grad">Submit message</a>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="col-lg-4 contact__img">
            <div class="img__wrap">
              <img src="/src/assets/img/bg/requests.png" alt="" />
            </div>
          </div>
        </div>
      </div>
