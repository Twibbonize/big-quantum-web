            ...
            <div class="row gx-5 align-items-center">
                <div class="col-lg-6 left__side">
                    <div class="content space-y-20">
                        <h1 class="hero__title">Sign up for The NFT,
                            Raroin newsletter!</h1>
                        <p class="hero__desc">Sign up to receive our monthly
                ...
                <div class="col-lg-6 right__side">
                    <img class="img-fluid hero__img"
                        src="src/assets/img/bg/newsletter.png" alt="newsletter">
                </div>
            </div>
        </div>
    </div>
